...
struct table_creator_one : public table_creator_base
{
    ...
    {
        sql << "create table soci_test(id numeric(10), val integer, c char, "
                 "str varchar(20), sh integer, ul numeric(20), d float, "
                 "num76 numeric(7,6), "
                 "tm date, i1 integer, i2 integer, i3 integer, "
                 "name varchar(20))";
    }
};
...
struct table_creator_two : public table_creator_base
{
        ...
        : table_creator_base(sql)
    {
        sql  << "create table soci_test(num_float float, num_int integer,"
                     " name varchar(20), sometime date, chr char)";
    }
};
...
struct table_creator_for_clob : table_creator_base
{
    table_creator_for_clob(soci::session& sql)
        : table_creator_base(sql)
    {
        sql << "create table soci_test(id integer, s long)";
    }
};
...
public:
    ...
    table_creator_base* table_creator_xml(soci::session& ) const SOCI_OVERRIDE
    {
        // return new table_creator_for_xml(s);
        return NULL;
    }

    table_creator_base* table_creator_clob(soci::session& ) const SOCI_OVERRIDE
    {
...
int main(int argc, char** argv)
{
    ...
    {
        connectString = "FILEDSN=./test-oracle.dsn";
    }
